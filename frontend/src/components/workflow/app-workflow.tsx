...
export function AppWorkflow() {
  ...
  async function analyze() {
    ...
    try {
      ...
      console.log("[UPLOAD] submitting analysis for user:", session?.id, "sessionId:", session?.sessionId);
      ...
      if (responseJson.success && responseJson.data) {
        ...
        // Persist complete backend unified profile & recommendations tagged with active session
        saveProfile({
          userId: session?.id,
